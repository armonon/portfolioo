...
export const radarLanes: RadarLane[] = [
  {
    ...
    bullets: ["Sattari Audio Suite internal test pack is available", "Auto Pitch remains blocked on real owned/cleared vocal WAVs", "StemDeck v0.3.6 laptop macOS 13+ pre-alpha b9f4909 package is available for DAW/listening tests"],
    nextAction: "Download the latest StemDeck v0.3.6 laptop macOS 13+ package from Product Radar and run laptop/DAW validation without beta/sale-ready claims.",
