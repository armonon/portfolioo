...
export const radarEvidenceLedger: RadarEvidenceItem[] = [
  {
    ...
    latestProof: "Public beta is live; deterministic 2026-05-23 cut-plan render produced a 3.6s MP4 proof at /downloads/scenepilot-export-proof-2026-05-23.mp4.",
    blocker: "Export proof exists; next blocker is wiring render/export into the UI and adding manual asset/timeline controls.",
    nextStep: "Add a visible UI affordance that explains rendered MP4 export is currently local-helper backed, then wire one-click export in the desktop/app path.",
