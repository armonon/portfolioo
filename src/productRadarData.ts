...
export const radarLanes: RadarLane[] = [
  {
    ...
    detail: {
      ...
      downloads: [
        ...
        { label: "Download StemDeck 0.4.0 standalone Mac app alpha", href: "/downloads/stemdeck-app-alpha-v0.4.0-standalone-app.tar.gz" },
...
export const radarSoftwareProjects: RadarSoftwareProject[] = [
  ...
  },
  {
    ...
    description: "Sattari StemDeck v0.4.0 standalone-app alpha is available as its own Apple Silicon Mac application package. The app-first package contains Sattari StemDeck.app at the top level, an install_app.sh helper for ~/Applications, the split live-mixer / arrangement-recorder UI, optional Demucs setup scripts, Rubber Band-backed time/pitch validation output, and architecture contracts. It is not notarized or sale-ready; the bottom arrangement space is an alpha workflow/capture surface, not a complete editable Ableton-style timeline yet.",
...
export const radarEvidenceLedger: RadarEvidenceItem[] = [
  ...
  },
  {
    ...
    latestProof: "StemDeck v0.4.0 standalone Mac app alpha is packaged/downloadable with Sattari StemDeck.app at the top level; validation passed standalone build, codesign strict verify, granular render contract, Rubber Band time/pitch benchmark, and architecture contract.",
