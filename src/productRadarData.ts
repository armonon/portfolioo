...
export const radarLanes: RadarLane[] = [
  {
    ...
    bullets: ["Sattari Hub 0.1.1 internal alpha download is available", "Auto Pitch 0.1.1 hubfix is available through the Hub update feed; Hub 0.1.1 embeds 7 Sattari products / 18 AU-VST3-Standalone payload entries", "Auto Pitch performer-modes build remains internal alpha and needs real vocal/DAW listening tests"],
...
export const radarSoftwareProjects: RadarSoftwareProject[] = [
  ...
  },
  {
    ...
    image: "/photos/auto-pitch-example.svg",
    summary: "One-download Sattari Hub installer/updater alpha with Project Radar plugin-update feed; Auto Pitch 0.1.1 hubfix payload is live for Apple Silicon Mac validation.",
