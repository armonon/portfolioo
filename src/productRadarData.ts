...
export const radarLanes: RadarLane[] = [
  {
    ...
    bullets: ["Sattari Audio Suite internal test pack is available", "Auto Pitch remains blocked on real owned/cleared vocal WAVs", "StemDeck v0.3.6 alpha package is included for DAW/listening tests"],
    nextAction: "Download the Sattari Audio Suite internal test pack and run laptop validation without beta/sale-ready claims.",
    ...
    detail: {
      ...
      downloads: [
        ...
        { label: "Download StemDeck v0.3.6 alpha", href: "/downloads/stemdeck-plugin-alpha-v0.3.6-dj-daw-architecture.tar.gz" },
...
export const radarSoftwareProjects: RadarSoftwareProject[] = [
  ...
  },
  {
    ...
    image: "/photos/auto-pitch-example.svg",
    summary: "Four-deck Sattari Audio remix plugin/app alpha with external stem lanes, beat sync, live key analysis, target-key matching, pads, mic monitor, recording, and DJ/DAW architecture seams.",
    description: "Sattari StemDeck v0.3.6 is available as a truth-labeled internal alpha package for DAW/listening tests. The build includes VST3 and Standalone artifacts, external Full/Drums/Bass/Music/Vocals stem lanes, host BPM sync, Beat Sync with per-deck Source BPM and Beat Grid Offset, LiveKey analysis, target-key matching/shifting, Preserve/key-lock routing, pads, mic monitoring, and WAV recording. It is not sale-ready until known-BPM/key DAW tests prove sync, LiveKey accuracy, and audio quality.",
...
export const radarEvidenceLedger: RadarEvidenceItem[] = [
  ...
  },
  {
    ...
    latestProof: "StemDeck v0.3.6 internal alpha package is downloadable with VST3/Standalone artifacts; validation passed build, codesign, granular/beat-sync/live-key/architecture contract checks, and pluginval strictness 5.",
