...
export const radarSoftwareProjects: RadarSoftwareProject[] = [
  ...
  },
  {
    ...
    image: "/photos/auto-pitch-example.svg",
    summary: "One-download Sattari Hub installer/updater alpha with Project Radar plugin-update feed plus the older suite test pack for Apple Silicon Mac validation.",
